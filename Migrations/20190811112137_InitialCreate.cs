    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblenrollment", x => new { x.ID, x.CrseCode });
                    table.UniqueConstraint("AK_tblenrollment_EnrollmentID", x => x.EnrollmentID);
                    table.ForeignKey(
                        name: "FK_tblenrollment_tblcourses_CrseCode",
                        column: x => x.CrseCode,
                        principalTable: "tblcourses",
                        principalColumn: "CrseCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tblenrollment_tblstudents_ID",
                        column: x => x.ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblenrollment_CrseCode",
                table: "tblenrollment",
                column: "CrseCode");
        }
